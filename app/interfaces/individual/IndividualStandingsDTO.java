...
public class IndividualStandingsDTO extends PlayerDTO implements Comparable{
    ...
    public IndividualStandingsDTO(){}

    public IndividualStandingsDTO(PlayerDTO playerDTO){
    ...
    public int compareTo(Object other) {
        IndividualStandingsDTO otherPlayer = (IndividualStandingsDTO) other;
